...
public class NetworkTask_stock extends AsyncTask<Map<String, String>, Integer, String> {
    private Context context;
    private int statusCode;

    public NetworkTask_stock(Context context){
...
// 응답 본문 가져오기
    ...
    protected void onPostExecute(String s) {
        if(s != null) {
            Toast.makeText(context, "재고 등록이 완료되었습니다.", Toast.LENGTH_SHORT).show();
            Log.d("HTTP", "Response from server : " + s);
        }
        else {
            Toast.makeText(context, "재고 등록에 문제가있습니다.", Toast.LENGTH_SHORT).show();
