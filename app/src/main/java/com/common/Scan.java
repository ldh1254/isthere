...
public class Scan {
    ...
    public static String localUrl = "http://52.78.243.10:8080/isthere";
    //public static String localUrl = "http://localhost:8080/isthere";
    ...
    public static String stockScan = "/stock/scan";
}
